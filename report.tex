...
\begin{enumerate}
	...
	\item $T-P$ - are actual voters which will not get a transportation and matbe will not vote at all as a result. big $T-P$ is bad, thus it will decrease the score.
\end{enumerate} 
...
best model for vote classification is  Random_Forest
\end{verbatim}
